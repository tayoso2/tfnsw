...
bridges_assets1 <- read_excel(paste0(path_b, "/Bridge mastersheet.xlsx"), range = "A1:AO450" ,sheet = "original mastersheet")
bridges_assets2 <- bridges_assets1 %>% select('Asset Category',	Zone,	Latitude, Longitude, ObjectID, 'Asset_Type', 'Project Name', CURRENT_ZONE,
...
bridges_bridges <- bridges_assets1 %>% select('Asset Category',	Zone,	Latitude, Longitude, ObjectID, 'Asset_Type', 'Project Name', CURRENT_ZONE,
                                              'Delivery Year',	'ROAD_NUMBER',	'CONSTRUCTION_YEAR', LIFE_SPAN, CY_STATUS, BNO,
                                              'FMECA_Code',	'FMECA_Asset Level 1',	'FMECA_Asset Level 2',	'FMECA_Asset Level 3',	'FMECA_Asset Level 4',	'FMECA_Rating',	
                                              'ConOps_Walk',	'ConOps_Cycle',	'ConOps_Transit',	'ConOps_Freight',	'ConOps_GV',	'ConOps_Score',	'ConOps_Rating') %>% 
...
fmeca1_bridges4 <- fmeca1_bridges3 %>% 
  # fmeca x conops
...
openxlsx::write.xlsx(fmeca1_bridges4, file = paste0(path_b, "/Bridges results.xlsx"))
