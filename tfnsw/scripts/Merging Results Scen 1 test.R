...
source("C:/Users/TOsosanya/Desktop/NSW/tfnsw/Merging Results Scen 1 non projects test.R")
...
write.csv(all_complete_project,"C:/Users/TOsosanya/Desktop/NSW/UVO/Scen 1-Project.csv",row.names = F)
write.csv(all_complete_solution,"C:/Users/TOsosanya/Desktop/NSW/UVO/Scen 1-Solution.csv",row.names = F)
write.csv(all_complete_measures,"C:/Users/TOsosanya/Desktop/NSW/UVO/Scen 1-Measures.csv",row.names = F)

## ends here


openxlsx::write.xlsx(all_complete, file = "C:/Users/TOsosanya/Desktop/NSW/Newdata 2705/Pavements/Pavement UVO 3 ids.xlsx")
