...
its_assets2 <- its_assets1 %>% select('Asset Category',	Zone,	WKT, ObjectID, 'Asset_Type', 'Project Name', CURRENT_ZONE,
...
openxlsx::write.xlsx(fmeca1_its4, file = paste0(path_i, "/ITS results.xlsx"))
